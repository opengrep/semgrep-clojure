...
(**
    Functions for parsing clojure programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a clojure program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.source, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a clojure program from a file into a typed OCaml CST.
